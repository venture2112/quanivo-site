  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 pt-20">
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-900 to-red-800">
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-white">
              Infrared Wellness Products
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
              Panels, beds, and saunas for deep heat therapy and detoxification
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Image src="/images/product-shot-1.png" alt="Infrared Products" width={600} height={500} className="rounded-xl shadow-lg" />
              </div>
              <div>
                <h2 className="text-4xl font-bold mb-6 text-gray-900">Infrared Therapy Solutions</h2>
                <p className="text-gray-600 text-lg mb-6">
                  Our infrared wellness products use far-infrared technology to deliver deep penetrating heat that promotes detoxification, pain relief, and relaxation.
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Deep tissue penetration</span></li>
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Detoxification support</span></li>
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Pain relief & recovery</span></li>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">Our Infrared Products</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Infrared Panels</h3>
                <p className="text-gray-600">Slim, wall-mounted panels that deliver targeted infrared heat therapy for any room.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Infrared Beds</h3>
                <p className="text-gray-600">Full-body infrared therapy beds for comprehensive wellness treatments.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Infrared Saunas</h3>
                <p className="text-gray-600">Traditional sauna experience enhanced with far-infrared technology.</p>
              </div>
            </div>
          </div>
        </section>
