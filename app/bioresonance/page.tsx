  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 pt-20">
        {/* Hero Section */}
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-purple-900 to-blue-800">
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-white">
              Quantum Bio-Wellness Energy Bed & Recliner
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
              Experience the future of wellness with our advanced bioresonance technology
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Image src="/images/hero-wellness-pod.jpeg" alt="Quantum Bio-Wellness Bed" width={600} height={500} className="rounded-xl shadow-lg" />
              </div>
              <div>
                <h2 className="text-4xl font-bold mb-6 text-gray-900">Revolutionary Bioresonance Technology</h2>
                <p className="text-gray-600 text-lg mb-6">
                  Our Quantum Bio-Wellness Energy Bed combines cutting-edge bioresonance technology with luxurious comfort to deliver a transformative wellness experience.
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Advanced frequency therapy</span></li>
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Cellular regeneration support</span></li>
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Stress reduction & relaxation</span></li>
                  <li className="flex items-center gap-3"><Check className="w-5 h-5 text-blue-600" /><span>Improved energy & vitality</span></li>
                </ul>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">How Bioresonance Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Frequency Alignment</h3>
                <p className="text-gray-600">Bioresonance technology uses specific frequencies to help align your body&apos;s natural energy fields, promoting balance and harmony.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Cellular Support</h3>
                <p className="text-gray-600">The gentle frequencies support cellular communication and regeneration, helping your body function at its optimal level.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Holistic Wellness</h3>
                <p className="text-gray-600">Experience benefits for both body and mind, including reduced stress, better sleep, and enhanced overall well-being.</p>
              </div>
            </div>
          </div>
        </section>
